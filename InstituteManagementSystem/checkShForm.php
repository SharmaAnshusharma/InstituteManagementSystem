...
<li class="active"><a href="ShortTermAdmission.php">Short Term Admission form </a></li>
...
echo "<script>alert('Email $email is already exist in our database, Please try another one!')</script>";  
	echo "<script>window.location='Admission.php'</script>";	
		 	...
		 	$ins=mysqli_query($con,"INSERT INTO `shstudentfrom`( `Date`, `Course`, `First Name`, `Last Name`, `DOB`, `Gender`, `Email`, `Contact`, `Address`, `Father Name`, `Father Contact`, `I Stream`, `I Board`, `I Year`, `I Percentage`, `H Stream`, `H Board`, `H Year`, `H Percentage`, `Short Student Adhar`, `Short Student Image`, `Fees`, `Password`) VALUES ('$date','$course','$fname','$lname','$dob','$gender','$email','$contact','$address','$fathername','$Fcon','$stream1','$uni1','$year1','$percentage1','$stream2','$uni2','$year2','$percentage2','$file_name1','$file_name2','$fees','$password')");
					if($ins==true)
					{
					echo "<script>alert('Inserted Successfully.')</script>";
						echo "<script>window.location='PrintShStudentDetails.php'</script>";	
					}
					else{
...
<a href="ShortTermAdmission.php" class="btn btn-danger">Back</a>
