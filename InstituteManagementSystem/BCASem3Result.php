...
if(isset($_POST['submit1']))
{
	...
	$roll=$_POST['roll'];
	$_SESSION['roll']=$roll;
	header('location: SemThreeResult.php');
	if(empty($roll))
	{
		echo "<script>alert('Roll Number Required')</script>";
	echo "<script>window.location='BCASem3Result.php'</script>";
	return false;
	}
	else
	{
...
<li class="active"><a href="BCASem3Result.php"><b style="font-size:20px;">Semester Three</b></a></li>
</ul>
</nav>
<div class="container">
<form method="post" >
<br/><br/><br/>
<h1<Semester Three</h1>
