...
if(isset($_POST['submit1']))
{
	...
	echo "<script>window.location='AlevelSem1Result.php'</script>";
	return false;
	}
	else
	{
	...
	$_SESSION['roll']=$roll;
	header('location: SemOneAlevel.php');
}
?>
<html>
<head>
...
<li class="active"><a href="AlevelSem1Result.php"><b style="font-size:20px">Semester One</b></a></li>
</ul>
</nav>
<div class="container">
<form method="post" >
