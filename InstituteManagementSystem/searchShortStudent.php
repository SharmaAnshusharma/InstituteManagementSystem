...
<li ><a href="searchStudentByRoll.php">Search Bachelor Students</a></li>
<li ><a href="SearchBachelorStudent.php">Search Short Students</a></li>
<li class="active"><a href="">Search Short Students</a></li>
...
$roll=$_POST['roll'];
	...
	$res=mysqli_query($con,"SELECT * FROM `shstudentfrom` WHERE `ID` ='$roll'");
	echo "<div class='table-responsive'>";
	echo "<table class='table table-striped'>";

	while($row=mysqli_fetch_array($res))
	{echo "<tr>";
	echo "<th>"; echo "Student Adhar"; echo "</th>";echo "<td>";echo "<img src='Stu_Tea_Image/".$row['Short Student Adhar']." ' width='100px' height='100px' >";echo "</td>";
	echo "</tr>";
	echo "<tr>";
	echo "<th>"; echo " Student Image"; echo "</th>";echo "<td>";echo "<img src='Stu_Tea_Image/".$row['Short Student Image']." ' width='100px' height='100px' >";echo "</td>";
echo "</tr>";
	echo "<tr>";
