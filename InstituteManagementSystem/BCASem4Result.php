...
if(isset($_POST['submit1']))
{
	...
	$roll=$_POST['roll'];
	$_SESSION['roll']=$roll;
	header('location: SemFoureResult.php');
	if(empty($roll))
	{
		echo "<script>alert('Roll Number Required')</script>";
	echo "<script>window.location='BCASem4Result.php'</script>";
	return false;
	}
	else
	{
...
<li class="active"><a href="BCASem4Result.php"><b style="font-size:20px;">Semester Four</b></a></li>
</ul>
</nav>
<div class="container">
<form method="post" >
