...
if(empty($a))
	...
	echo "<script>window.location='UpdateNonFormal.php'</script>";
		return false;
	}
	else
	{
...
$res=mysqli_query($con,"UPDATE `nonformalcourse` SET `Fee`= Fee + $a  where ID = $b");
if($res==true)
{
...
<li class="active"><a href="UpdateNonFormal.php">Update NonFormal Fees</a></li>
<li><a href="Fees.php">Course Fees </a></li>
</ul>
</nav><br/><br/><br/><br/><br/><br/><br/>
<div class="container">
<div class="panel panel-default">
<div class="panel panel-heading"><h1><center><h1>Update NonFormal Fees</h1></center></h1></div>
