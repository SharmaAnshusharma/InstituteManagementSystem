...
$res=mysqli_query($con,"DELETE FROM `ugstudentform` WHERE ID = $b");
if($res==true)
{
...
<li class="active"><a href="DeleteStudentDetails.php">Delete Student Details</a></li>
</ul>
</nav><br/>
<div class="container">
<div class="panel panel-default">
<div class="panel panel-heading"><center><h1>Delete Student Details</h1></center></div>
