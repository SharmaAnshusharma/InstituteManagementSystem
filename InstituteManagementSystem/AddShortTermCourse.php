...
<li class="active"><a href="AddShortTermCourse.php"><b style="font-size:20px;">Add Short Term Course</b></a></li>
</ul>
</div>
</nav>
<br/>
...
<div class="panel panel-heading"><center><h1>Add Short-Term Course</h1></center></div>
...
// First Name validation
	...
	if(!preg_match("/^[a-zA-Z ]*$/",$name))
	{
		echo "<script>alert('Only Letter are Required in Name') </script>";
				echo "<script>window.location='AddShortTermCourse.php' </script>";
...
$ins=mysqli_query($con,"INSERT INTO `shorttermcourse`( `Name`, `Fees`, `Security`, `Duration`) VALUES ('$course','$fees','$security','$duration');");
if($ins==true)
{
