...
if(empty($a))
	...
	echo "<script>window.location='UpdateShortTerm.php'</script>";
		return false;
	}
	else
	{
...
if(empty($b))
	...
	else
	{
		if(!preg_match("/^[0-9]*$/",$b))
	{
		echo "<script>alert('Only Numeric Values are allowed in Course ID ')</script>";
		echo "<script>window.location='UpdateShortTerm.php'</script>";
		return false;
...
$res=mysqli_query($con,"UPDATE `shorttermcourse` SET `Fees`=Fees +$a WHERE ID = $b");
if($res==true)
{
...
<li class="active"><a href="UpdateShortTerm.php">Update Short Term Course</a></li>
<li><a href="Fees.php">Course Fees </a></li>
</ul>
</nav><br/><br/><br/><br/><br/><br/><br/>
<div class="container">
<div class="panel panel-default">
<div class="panel panel-heading"><h1><center><h1>Update Short Term Fees</h1></center></h1></div>
<div class="panel panel-body">
<form method="post">
<b>Update Value:</b><input type="text" name="a" class="form-control"><br/>
<b>Course ID:</b><input type="text" name="b" class="form-control" ><br/>
<input type="submit" value="Update Fees" name="submit1" class="btn btn-primary">
</form>
</body>
</html>