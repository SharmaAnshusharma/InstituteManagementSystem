...
{	
	...
	echo "<script>window.location='ALevelResult.php'</script>";	
	return false;
	}
	else
	{
...
echo "<script>window.location='ALevelResult.php'</script>";	return false;
	}
else
{
...
else
{
	...
	$ins=mysqli_query($con,"INSERT INTO `alevelsem1`(`Roll`, `Name`, `Sub1`, `Sub2`, `Sub3`, `Sub4`, `Sub5`, `Sub6`, `Marks1`, `Marks2`, `Marks3`, `Marks4`, `Marks5`, `Marks6`) VALUES ('$roll','$name','$sub1','$sub2','$sub3','$sub4','$sub5','$sub6','$marks1','$marks2','$marks3','$marks4','$marks5','$marks6')");
	if($ins==true)
	{
...
else
{
	...
	$con=mysqli_connect("localhost","root","");
	mysqli_select_db($con,"iceproject");
	$ins=mysqli_query($con,"INSERT INTO `alevelsem2`(`Roll`, `Name`, `Sub1`, `Sub2`, `Sub3`, `Sub4`, `Sub5`, `Sub6`, `Marks1`, `Marks2`, `Marks3`, `Marks4`, `Marks5`, `Marks6`) VALUES ('$roll','$name','$sub1','$sub2','$sub3','$sub4','$sub5','$sub6','$marks1','$marks2','$marks3','$marks4','$marks5','$marks6')");
	if($ins==true)
	{
		echo "<script>alert('Result Uploaded Successfully')</script>";
	}
...
<li class="active"><a href="BCAResult.php"><b style="font-size:20px;">A Level Ressult</b></a></li>
</ul>
</nav>
<body>
<div class="container">
...
<div class="panel panel-heading"><center><h1>A Level Semester One</h1></center></div>
...
<tr><td><input type="text" name="sub4" class="form-control col-sm-4"required></td><td><input type="text" name="marks4" class="form-control col-sm-4"required></td></tr>
<tr><td><input type="text" name="sub5" class="form-control col-sm-4"required></td><td><input type="text" name="marks5" class="form-control col-sm-4"required></td></tr>
<tr><td><input type="text" name="sub6" class="form-control col-sm-4"required></td><td><input type="text" name="marks6" class="form-control col-sm-4"required></td></tr>
...
<h3>Semester Two</h3>
<div class="panel panel-default">
<div class="panel panel-heading"><center><h1>A Level Semester Two</h1></center></div>
<div class="panel panel-body">
