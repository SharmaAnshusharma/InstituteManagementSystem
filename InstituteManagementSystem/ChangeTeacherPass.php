...
if(isset($_POST['submit1']))
{
	...
	$result=mysqli_query($con,"UPDATE `teacherform` SET `Password`= '$password' WHERE `ID` = '$id';");
	if($result==true)
	{
...
<li class="active"><a href="ChangeTeacherPass.php">Change Teacher Password</a></li>
</ul>
</nav>
<br/><br/>
<div class="container">
<div class="panel panel-default">
<div class="panel panel-heading"><h1>change Password</h1></div>
