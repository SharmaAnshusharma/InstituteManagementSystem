...
else
{
	...
	$ins=mysqli_query($con,"INSERT INTO `bcasem3`(`Roll`, `Name`, `Sub1`, `Sub2`, `Sub3`, `Sub4`, `Sub5`, `Sub6`, `Sub7`, `Sub8`, `Marks1`, `Marks2`, `Marks3`, `Marks4`, `Marks5`, `Marks6`, `Marks7`, `Marks8`) VALUES ('$roll','$name','$sub1','$sub2','$sub3','$sub4','$sub5','$sub6','$sub7','$sub8','$marks1','$marks2','$marks3','$marks4','$marks5','$marks6','$marks7','$marks8')");
	if($ins==true)
	{
...
<div class="panel panel-heading"><center><h1>BCA Semester Three</h1></center></div>
...
<tr><td>Lab:</td><td><input type="text" name="sub8" class="form-control col-sm-4"required></td><td><input type="text" name="marks8" class="form-control col-sm-4required"></td></tr>
</table>
<br/>
