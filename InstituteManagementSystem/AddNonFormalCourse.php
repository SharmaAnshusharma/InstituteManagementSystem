...
<title>Add Non-Formal Course</title>
<!---->
...
<div class="panel panel-heading"><center><h1>Add Non-Formal Course</h1></center></div>
...
// First Name validation
	...
	if(!preg_match("/^[a-zA-Z ]*$/",$name))
	{
		echo "<script>alert('Only Letter are Required in Name') </script>";
				echo "<script>window.location='AddNonFormalCourse.php' </script>";
...
$ins=mysqli_query($con,"INSERT INTO `nonformalcourse`(`Name`, `Fee`, `Security`, `Duration`) VALUES ('$course','$fees','$security','$duration')");
if($ins==true)
{
