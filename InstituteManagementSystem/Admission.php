<?php
include("AdmissionValidation.php");
?>
<html>
<head>
<style>
...
<li class="active"><a href="Admission.php"><b style="font-size:20px;">Admission form </b></a></li>
</ul>

</nav>
<div class="container">
<div class="panel panel-default">
<div class="panel panel-heading"><center><h1>UG Admission Form</h1></center></div>
