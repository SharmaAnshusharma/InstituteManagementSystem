<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT id FROM `shstudentfrom` WHERE Email = '$myusername' and Password = '$mypassword'";
...
<li><a href="Student.php"><b style="font-size:20px;"> UG Student Login</b></a></li>
<li  class="active"><a href="ShortStudentLogin.php"><b style="font-size:20px;">Short Term Student Login</b></a></li>
</ul>
...
<div class="container" style="padding-left:300px;">
  ...
  <div class="panel panel-default col-sm-7">
  	<h4><mark>Short Term Student Login</mark></h4>
